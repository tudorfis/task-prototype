(function () {
    ...
    function flotChartCtrl($scope) {
        ...
        $scope.barChartSimpleH = {};
        $scope.barChartSimpleH.data = [
            {
                label: " A",
        ...
        $scope.barChartSimpleH.options = {
            ...
            colors: [$scope.color.gray, $scope.color.primary]
        };


        sampledata1 = [[1, 65], [2, 59], [3, 90], [4, 81], [5, 56], [6, 55], [7, 68], [8, 45], [9, 66]];
        sampledata2 = [[1, 28], [2, 48], [3, 30], [4, 60], [5, 100], [6, 50], [7, 10], [8, 25], [9, 50]];
        $scope.barChartSimpleV = {};
        $scope.barChartSimpleV.data = [
            {
                label: " A",
                data: [[1, 65], [2, 59], [3, 90], [4, 81], [5, 56], [6, 55]],
                bars: {
                    order: 0,
                    fillColor: {
                        colors: [
                ...
                label: " B",
                data: [[1, 28], [2, 48], [3, 30], [4, 60], [5, 100], [6, 50]],
                bars: {
                    order: 1,
                    show: true,
                    fill: true,
        ...
        $scope.barChart1.data = [
            {
                label: "Value A",
                data: [[2009, 10], [2010, 5], [2011, 5], [2012, 15], [2013, 28]],
                bars: {
                    order: 0
                }
            }, {
                label: "Value B",
                data: [[2009, 22], [2010, 4], [2011, 12], [2012, 14], [2013, 13]],
                bars: {
                    order: 1
                }
            }, {
                label: "Value C",
                data: [[2009, 15], [2010, 2], [2011, 19], [2012, 8], [2013, 11]],
                bars: {
                    order: 2
                }
            }
        ...
        $scope.barChart1.options = {
            ...
            colors: [$scope.color.primary, $scope.color.info, $scope.color.success]
        };
